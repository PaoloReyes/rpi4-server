...
def stock_portfolio_register_data(hey: float = 0.0, bbva: float = 0.0, nu: float = 0.0, up_sivale: float = 0.0, fibras: float = 0.0, etfs: float = 0.0, cetes: float = 0.0, savings_fund: float = 0.0, finsus: float = 0.0, mercado_pago: float = 0.0, bitso: float = 0.0, cash: float = 0.0):
    return portfolio.register_data(hey, bbva, nu, up_sivale, fibras, etfs, cetes, savings_fund, finsus, mercado_pago, bitso, cash)
